...
候选池不再是手写的 3 条，而是从真实文件里枚举出的函数（codejev/candidate.py），
...
from codejev.jev_engine import TypesafeConfig, TypesafeEngine

SOURCE = Path(__file__).resolve().parent.parent / "codejev" / "candidate.py"
